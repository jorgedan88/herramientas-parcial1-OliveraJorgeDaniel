...

{
    ...
    public List<Piloto> GetAll(string nameFilterIns){
        ...
        {
            // query = query.Where(x => x.PilotoNombre.Contains(nameFilterIns) ||
            //  x.PilotoApellido.Contains(nameFilterIns) || x.PilotoDni.ToString() == nameFilterIns);
            ...
            query = query.Where(x =>
                ...
                //x.PilotoDni.ToUpper().Contains(filterUpper) ||
